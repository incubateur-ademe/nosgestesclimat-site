...
Pour comparer les modes de transports, nous utilisons souvent la notion d’ordre de grandeur. C’est un facteur (en général 10) permettant de quantifier l’impact d’un mode par rapport à un autre. Exemple : la voiture a 10 fois plus d’impact que le bus au km ou est d’un ordre de grandeur supérieur au bus. L’avion est deux ordres de grandeur (100 fois) supérieur au TGV par km-passager. L’objectif de [ce calculateur](https://impactco2.fr/transport) est de visualiser les ordres de grandeur pour une distance donnée en comparant différents modes de transport. Rendre visible ce dont il est difficile de se rendre compte lorsque l’on choisit tel ou tel moyen de locomotion.
